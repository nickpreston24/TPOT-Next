import {
  ...
  AlertDialogHeader,
  AlertDialogOverlay
} from '@chakra-ui/core/dist/AlertDialog'
...
import { removeSession, sessions, unlockSession } from '@stores/sessionsAPI'
        ...
        <Flex height={150} flexGrow={1} maxW={800} px={6} py={2}>
          ...
          <Stack w='50%'>
            ...
            <Stack flexGrow={1} justifyContent='flex-end' alignItems='flex-end' direction='row'>
              ...
              <Tooltip label='Unlock this session' placement='bottom' aria-label='unlock-session'>
                <Button
...
const CategoryBadges = ({ categories = [] }) => {
  return (
    <Stack justify='space-between' isInline flexWrap='wrap'>
      <Box minW='80px' fontWeight='bold'>
        Categories
      </Box>
